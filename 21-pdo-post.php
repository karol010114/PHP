<?php
    ...
    try{
        ...
        `sintoma_tos`, `sintomas_fiebre`, `sintomas_disnea`, `sintomas_dolormuscular`,
        `sintomas_gripe`, `sintomas_presionalta`, `sintoma_fatiga`, `sintoma_garraspera`,
        `ultima_fecha_vacunacion`, `resultado`)
        VALUES ('$nombre', '$apellido', '$edad', '$talla', '$peso', '$tos',
        '$fiebre', '$disnea', '$dolor_muscular', '$gripe', '$Presion_alta',
        '$Fatiga', '$Garraspera', '$fecha', '$resultado');";
